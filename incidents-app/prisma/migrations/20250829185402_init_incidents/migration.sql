-- CreateEnum
CREATE TYPE "public"."UserRole" AS ENUM ('DRIVER', 'FLEET_MANAGER', 'ADMIN');
...
-- CreateIndex
CREATE UNIQUE INDEX "Car_regNumber_key" ON "public"."Car"("regNumber");
...
-- AddForeignKey
ALTER TABLE "public"."incidents" ADD CONSTRAINT "incidents_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
